    ...
    <View className="flex-row items-center space-x-3">
      ...
      <View>
        ...
        <Text className="text-gray-100 text-sm">
          Previous: ₱{item.subPrice}
        </Text>
      </View>
    </View>
    <View>
      <Text className="text-primary text-base font-pbold text-right">
        ₱{item.price}
      </Text>
    </View>
  </View>
  ...
  return (
    <View>
      <View className="flex-row justify-between items-center mb-3">
        <View>
          <Text className="text-black text-lg font-pbold">
            Daily Market Price
          </Text>
          <Text className="text-gray-100 text-sm">Average: ₱{average}/kg</Text>
        </View>
        <TouchableOpacity onPress={onViewAll}>
          <Text className="text-primary font-pmedium">View All</Text>
        </TouchableOpacity>
      </View>
